...
<?php require 'inc/header_add_advert.php'; ?>
...
<?php endif; ?>
<div style="margin: 3rem;" class="ui container">
    <div class="ui segment">
        <h1 style="margin: 1rem;" class="ui center aligned header">VOS ANNONCES</h1>
        <?php while ($adverts = $result_adverts->fetch(PDO::FETCH_OBJ)) {
            if ($adverts->id_users == $_SESSION['auth']->id) { ?>
                <form action="crud_advert.php" enctype="multipart/form-data" class="ui form" method="POST">
                    <div class="field">
                        <input type="hidden" name="MAX_FILE_SIZE" value="100000000">
                    </div>
                    <div class="field">
                        <label for="main_img_ad">Image Principale de L'annonce</label>
                        <img src="<?= $adverts->main_img_ad ?>" alt="" class="ui small image">
                        <input type="file" name="main_img_ad" value="<?= $adverts->main_img_ad ?>">
                    </div>
                    <div class="field">
                        <label for="sacondary_img_ad">Image Secondaire de L'annonce</label>
                        <img src="<?= $adverts->secondary_img_ad ?>" alt="" class="ui small image">
                        <input type="file" name="secondary_img_ad" value="<?= $adverts->secondary_img_ad ?>">
                    </div>
                    <div class="field">
                        <label for="name_ad">Nom de l'annonce : </label>
                        <input name="name_ad" type="text" placeholder="Nom" value="<?= $adverts->name_ad ?>">
                    </div>
                    <div class="field">
                        <label for="description_ad">Description de l'annonce : </label>
                        <textarea name="description_ad" placeholder="Description" cols="30" rows="10"><?= $adverts->description_ad ?></textarea>
                    </div>
                    <div class="field" style="width: 100px;">
                        <div class="ui right labeled input">
                            <label for="amount" class="ui label">€</label>
                            <input type="number" placeholder="Prix" id="price_ad" name="price_ad" value="<?= $adverts->price_ad ?>">
                            <div class="ui basic label">Personne</div>
                        </div>
                    </div>
                    <div class="field">
                        <label for="position_ad">Localisation de l'annonce : </label>
                        <input name="position_ad" type="text" placeholder="Localisation de l'annonce" value="<?= $adverts->position_ad ?>">
                        <input type="hidden" name="id_ad" value="<?php echo $adverts->id_ad ?>">
                    </div>
                    <div class="field">
                        <label>Pays</label>
                        <div class="ui fluid search selection dropdown">
                            <input type="hidden" name="country" value="<?= $adverts->country ?>">
                            <i class="dropdown icon"></i>
                            <div class="default text">Choisir un Pays</div>
                            <div class="menu">
                    ...
                    <button class='ui fluid bottom attached orange button' type="submit" name="modify">Modifier l'annonce</button>
                    <button class='ui fluid bottom attached negative button' type="submit" name="supprimer"><i class="trash icon"></i>Supprimer l'annonce</button>
    ...
    <div class="ui segment">
        <h1 style="margin: 1rem;" class="ui center aligned header">AJOUTER UNE ANNONCE</h1>
        <form class="ui form" method="post" action="crud_advert.php" enctype="multipart/form-data">
            <div class="field">
                <input type="hidden" name="MAX_FILE_SIZE" value="100000000">
            </div>
            <div class="field">
                <label for="main_img_ad">Image Principale de L'annonce</label>
                <input type="file" name="main_img_ad">
            </div>
            <div class="field">
                <label for="sacondary_img_ad">Image Secondaire de L'annonce</label>
                <input type="file" name="secondary_img_ad">
            </div>
            <div class="field">
                <label for="name_ad">Nom de l'annonce : </label>
                <input name="name_ad" type="text" placeholder="Nom">
            </div>
            <div class="field">
                <label for="description_ad">Description de l'annonce : </label>
                <textarea name="description_ad" placeholder="Description" cols="30" rows="10"></textarea>
            </div>
            <div class="field" style="width: 100px;">
                <div class="ui right labeled input">
                    <label for="amount" class="ui label">€</label>
                    <input type="number" placeholder="Prix" id="price_ad" name="price_ad">
                    <div class="ui basic label">Personne</div>
                </div>
            </div>
            <div class="field">
                <label for="position_ad">Localisation de l'annonce : </label>
                <input name="position_ad" type="text" placeholder="Localisation de l'annonce">
                <input type="hidden" name="id_user" value="<?php echo $_SESSION['auth']->id ?>">
            </div>
            <div class="field">
                <label>Pays</label>
                <div class="ui fluid search selection dropdown">
            ...
            <button type="submit" name="ajouter" class="ui fluid bottom attached positive button">Ajouter une annonce</button>
        </form>
    </div>
</div>
